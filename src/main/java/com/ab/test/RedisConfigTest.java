...
import com.ab.entity.UserVo;
import com.ab.service.RedisService;
import com.ab.utils.RedisKeyUtil;
...
public class RedisConfigTest {
    ...
    public void HashOperations() throws Exception {
        ...
        log.info("{}", hashOperations.get("hash:user", userVo.hashCode() + ""));
    }
...
//        System.out.println(listOperations.leftPop("list:user"));
        // pop之后 值会消失
        log.info("{}", listOperations.leftPop("list:user"));
    }
}